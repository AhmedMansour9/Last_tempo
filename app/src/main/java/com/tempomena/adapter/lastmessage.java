...
//        }
        ...
        String MyName=SharedPrefManager.getInstance(context).getMyName();
        if(MyName.equals(array.get(position).getRecieved_from())){
            holder.T_userName.setText(array.get(position).getSend_to());
        }else {
